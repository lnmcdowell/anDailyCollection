...
class OldMapVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myScrollView.addSubview(SFCImageView)
        ...
        myScrollView.addSubview(SFC2ndImageView)
        ...
        myScrollView.addSubview(SFC3rdImageView)
        SFC3rdImageView.doConstraints(top: SFC2ndImageView.bottomAnchor, leading: mv.leadingAnchor, bottom: nil, trailing: nil, topPad: 20, leadPad: 0, botPad: 0, trailPad: 0, width: 400, height: 300)
        myScrollView.contentSize.width = self.view.frame.width
